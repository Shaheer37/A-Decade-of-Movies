...
class MovieSearchViewModel @Inject constructor(
    ...
    fun searchMovies(query: String = "")
        = query.replace(" ", "").toLowerCase(Locale.ROOT)
        .isDifferentQueryThanPrevious(lastSearch) { query ->
    ...
    private fun String.isDifferentQueryThanPrevious(previous: String?, performIfTrue: ((String)->Unit)){
        if(this != previous) {
            lastSearch = this
            performIfTrue.invoke(this)
        }
    }
